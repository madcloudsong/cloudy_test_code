...
<?php
/**
 * Simple Description file demo
 * 
 * Complete Description of  demo
 * 
...
require('/data/web_deployment/websocket/php-websocket/lib/SplClassLoader.php');

$classLoader = new SplClassLoader('Wrench', '/data/web_deployment/websocket/php-websocket/lib');
$classLoader->register();
require './ChatApplication.php';

$server = new \Wrench\Server('ws://localhost:4000/', array(
